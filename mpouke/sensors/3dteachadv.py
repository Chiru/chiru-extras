...
output = csv.writer(open('advanced.csv', 'a'), delimiter=',')
port = "/dev/rfcomm1"
...
while True:
    ...
    print  "****************************************************"
    print "1: Circle, 2: Bracket, 3: Saw, 4: Square 5. Grasp"
    #dump = ser.readline()
    #print dump
    selection = raw_input()
    ...
    if selection == '2':
    	    print "Get ready to record 'Bracket' in 3..."
	    sleep(1)
	    print "2..."
	    sleep(1)
	    print "1..."
    ...
    if selection == '3':
    	    print "Get ready to record 'Saw' in 3..."
	    sleep(1)
	    print "2..."
	    sleep(1)
	    print "1..."
