...
def draw_map():
    ...
    if COMPARISONMODE == True:
        for n in xrange(len(xynodes)):
            ...
            if comparisondict[n] < -40: pygame.draw.polygon(screen, bischeme[0], intnode, 0)
            if comparisondict[n] > -40 and comparisondict[n] <= -30: pygame.draw.polygon(screen, bischeme[1], intnode, 0)
            if comparisondict[n] > -30 and comparisondict[n] <= -20: pygame.draw.polygon(screen, bischeme[2], intnode, 0)
            if comparisondict[n] > -20 and comparisondict[n] <= -10: pygame.draw.polygon(screen, bischeme[3], intnode, 0)
            if comparisondict[n] > -10 and comparisondict[n] <= 0: pygame.draw.polygon(screen, bischeme[4], intnode, 0)
            if comparisondict[n] > 0 and comparisondict[n] <= 10: pygame.draw.polygon(screen, bischeme[5], intnode, 0)
            if comparisondict[n] > 10 and comparisondict[n] <= 20: pygame.draw.polygon(screen, bischeme[6], intnode, 0)
            if comparisondict[n] > 20 and comparisondict[n] <= 30: pygame.draw.polygon(screen, bischeme[7], intnode, 0)
            if comparisondict[n] > 30 and comparisondict[n] <= 40: pygame.draw.polygon(screen, bischeme[8], intnode, 0)
            if comparisondict[n] > 50: pygame.draw.polygon(screen, bischeme[9], intnode, 0)
...
if __name__ == "__main__":
    ...
    #dstmp = time.strptime(day,"%Y-%m-%d")
    #print dstmp
    hour = '8' #Do not put leading zeros, e.g. use 8 instead of 08
