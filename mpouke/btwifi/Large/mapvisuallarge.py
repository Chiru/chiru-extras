...
btvw = open('btvisualweights.csv','w')
rvw = open('rvisualweights.csv','w')
btwriter = csv.writer(btvw,delimiter=',')
rwriter = csv.writer(rvw,delimiter=',')
...
def draw_map():
    for n in xrange(len(xynodes)):
        ...
        if nodevisual[n] > 70: pygame.draw.polygon(screen, heatscheme[7], intnode, 0)
